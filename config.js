...
global.web_settings = {
  head: {
    title: 'Ryuu API',
    description: 'Ryuu API adalah Restfull API\'s yang dibuat dengan Node.js',
    author: 'Ryuu Code',
    keywords: 'Rest-API, Restfull-API, API-Rest, Telnyx-MD, api, Ryuu-Code',
...
global.password_admin = 'Ryuuzxycode';
global.author = 'Ryuu';
